          ...
          <div className="grid gap-2">
            ...
            <div className="relative">
              <Slider
                ...
                className="[&_.bg-primary]:bg-transparent [&_.bg-secondary]:bg-transparent relative flex items-center select-none touch-none w-full h-5 rounded-2xl"
                style={{
